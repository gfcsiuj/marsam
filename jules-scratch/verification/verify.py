...
async def main():
    async with async_playwright() as p:
        ...
        header_desktop = page.locator('.header')
        await header_desktop.screenshot(path="jules-scratch/verification/desktop_view.png")

        # Mobile screenshot
        await page.set_viewport_size({"width": 375, "height": 667})
        header_mobile = page.locator('.header')
        await header_mobile.screenshot(path="jules-scratch/verification/mobile_view.png")
